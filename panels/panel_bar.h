...
#ifndef WINDOW_MANAGER_PANELS_PANEL_BAR_H_
#define WINDOW_MANAGER_PANELS_PANEL_BAR_H_
...
class PanelBar : public PanelContainer {
 public:
  ...
  virtual bool ShouldAddDraggedPanel(const Panel* panel, const Point& drag_pos);
...
#endif  // WINDOW_MANAGER_PANELS_PANEL_BAR_H_
